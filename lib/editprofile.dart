...
class _EditprofileWidgetState extends State<EditprofileWidget> {
  ...
  void initState() {
    ...
    _model.nameController ??= TextEditingController(text: 'Jenny');
    _model.nameFocusNode ??= FocusNode();

    _model.emailController ??= TextEditingController(text: 'jenny@gmail.com');
    _model.emailFocusNode ??= FocusNode();

    _model.phoneController ??= TextEditingController(text: '+977-984120225');
    _model.phoneFocusNode ??= FocusNode();

    _model.passwordController ??= TextEditingController(text: '87777777');
